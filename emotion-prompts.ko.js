...
globalThis.EMOTION_PROMPTS_KO = {
  ...
  arousal: '흥분 (Arousal): 눈을 가늘게 뜨거나 살짝 위로 향한 채 입을 반쯤 벌리고 헐떡이는 표정. 눈썹이 살짝 찌푸려지고 머리카락과 옷이 땀에 살짝 젖어 있는 상태로 변경',
  orgasm: '절정 (Orgasm): 최고조의 오르가즘을 느끼는 표정으로 변경. 머리카락이 젖고 헝클어진다. 땀을 흘린다. 의상이 정돈되지 못하다. 눈알이 반쯤 위로 올라간다.',
  ecstasy: '엑스터시 (Ecstasy): 강한 도취감과 황홀함이 얼굴 전반에 퍼진 표정으로 변경. 약간의 땀을 흘리며 감정 고조가 즉시 드러나게',
